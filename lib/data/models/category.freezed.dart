...
class _$CategoryCopyWithImpl<$Res, $Val extends Category> implements $CategoryCopyWith<$Res> {
  ...
  @override
  $Res call({Object? id = null, Object? name = null, Object? slug = null, Object? icon = null}) {
    return _then(
      _value.copyWith(
            id: null == id
                ? _value.id
...
class _$CategoryImpl implements _Category {
  const _$CategoryImpl({required this.id, required this.name, required this.slug, required this.icon});
...
abstract class _Category implements Category {
  const factory _Category({required final String id, required final String name, required final String slug, required final String icon}) = _$CategoryImpl;
